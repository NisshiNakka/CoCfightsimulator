...
ActiveRecord::Schema[7.0].define(version: 2026_01_08_092712) do
  ...
  create_table "attacks", force: :cascade do |t|
    ...
    t.integer "dice_correction", default: 0, null: false
  ...
  create_table "characters", force: :cascade do |t|
    ...
    t.integer "evasion_correction", default: 0, null: false
    t.integer "armor", default: 0, null: false
    t.string "damage_bonus", limit: 15, default: "0", null: false
